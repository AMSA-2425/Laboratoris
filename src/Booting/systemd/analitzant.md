...
## Contingut
- [Creant i Gestionant serveis](./systemd/servei.md)
- [Serveis programats](./systemd/programats.md)
- [Anàlisi de logs](./systemd/logs.md)
- [journalctl versus dmesg](./systemd/journalctl-dmesg.md)    
- [Afegint informació d'inici](./systemd/inici.md)
